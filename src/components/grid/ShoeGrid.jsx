...
// --- REAL DATA IMPORT ---
import shoes from "../../../backend/bags.json";
...
export default function ShoeGrid() {
    ...
    // Filter state for Footwear collection
    ...
    // Initial grid uses Footwear collection (index 0)
    const [gridLayers, setGridLayers] = useState(() => [
        {
            id: "init",
            items: shoes.filter((s) => s.brand === "Moroccan Footwear"),
